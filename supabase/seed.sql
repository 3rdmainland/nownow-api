...
-- ──────────────────────────────────────────────────────────────────────────────
-- Vendor Menu Items (legacy — 6 required by load test + extras)
-- ──────────────────────────────────────────────────────────────────────────────
INSERT INTO vendor_menu_items (id, vendor_id, category_id, name, description, price, type, prep_time, available) VALUES
  -- Vendor 1
  ('ff000000-0000-0000-0000-000000000001', '00000000-0000-0000-0000-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Classic Burger', 'Delicious Classic Burger', 65, 'FOOD', 10, true),
  ('ff000000-0000-0000-0000-000000000002', '00000000-0000-0000-0000-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Cheese Burger', 'Delicious Cheese Burger', 75, 'FOOD', 10, true),
  ('ff000000-0000-0000-0000-000000000003', '00000000-0000-0000-0000-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Loaded Fries', 'Delicious Loaded Fries', 45, 'FOOD', 10, true),
  ('ff000000-0000-0000-0000-000000000010', '00000000-0000-0000-0000-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Double Smash Burger', 'Two patties, double cheese', 95, 'FOOD', 12, true),
  ('ff000000-0000-0000-0000-000000000011', '00000000-0000-0000-0000-000000000001', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Chicken Burger', 'Crispy chicken fillet', 70, 'FOOD', 10, true),
  -- Vendor 2
  ('ff000000-0000-0000-0000-000000000004', '00000000-0000-0000-0000-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Margherita', 'Delicious Margherita', 85, 'FOOD', 10, true),
  ('ff000000-0000-0000-0000-000000000005', '00000000-0000-0000-0000-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Pepperoni', 'Delicious Pepperoni', 95, 'FOOD', 10, true),
  ('ff000000-0000-0000-0000-000000000006', '00000000-0000-0000-0000-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Hawaiian', 'Delicious Hawaiian', 90, 'FOOD', 10, true),
  ('ff000000-0000-0000-0000-000000000012', '00000000-0000-0000-0000-000000000002', 'bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb', 'Four Cheese', 'Mozzarella, cheddar, gorgonzola, parmesan', 110, 'FOOD', 12, true),
  -- Vendor 3 (Nigerian)
  ('ff000000-0000-0000-0000-000000000020', '00000000-0000-0000-0000-000000000003', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab', 'Jollof Rice', 'Party jollof with chicken', 80, 'FOOD', 15, true),
  ('ff000000-0000-0000-0000-000000000021', '00000000-0000-0000-0000-000000000003', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab', 'Pounded Yam & Egusi', 'With assorted meat', 95, 'FOOD', 20, true),
  ('ff000000-0000-0000-0000-000000000022', '00000000-0000-0000-0000-000000000003', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab', 'Suya Platter', 'Spicy grilled beef skewers', 70, 'FOOD', 12, true),
  ('ff000000-0000-0000-0000-000000000023', '00000000-0000-0000-0000-000000000003', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaab', 'Fried Plantain', 'Sweet ripe plantain', 30, 'FOOD', 5, true),
  -- Vendor 4 (Braai)
  ('ff000000-0000-0000-0000-000000000030', '00000000-0000-0000-0000-000000000004', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaae', 'Boerewors Roll', 'Classic SA boerewors', 55, 'FOOD', 10, true),
  ('ff000000-0000-0000-0000-000000000031', '00000000-0000-0000-0000-000000000004', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaae', 'Braai Platter', 'Steak, chops, wors, sides', 150, 'FOOD', 25, true),
  ('ff000000-0000-0000-0000-000000000032', '00000000-0000-0000-0000-000000000004', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaae', 'Pap & Sheba', 'Maize meal with tomato relish', 40, 'FOOD', 8, true),
  -- Vendor 5 (Juice)
  ('ff000000-0000-0000-0000-000000000040', '00000000-0000-0000-0000-000000000005', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac', 'Green Detox', 'Spinach, apple, ginger', 45, 'FOOD', 3, true),
  ('ff000000-0000-0000-0000-000000000041', '00000000-0000-0000-0000-000000000005', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac', 'Berry Blast', 'Mixed berries smoothie', 50, 'FOOD', 3, true),
  ('ff000000-0000-0000-0000-000000000042', '00000000-0000-0000-0000-000000000005', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaac', 'Mango Lassi', 'Creamy mango yogurt', 40, 'FOOD', 3, true),
  -- Vendor 7 (Chicken)
  ('ff000000-0000-0000-0000-000000000050', '00000000-0000-0000-0000-000000000007', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Quarter Chicken', 'Flame-grilled quarter', 55, 'FOOD', 12, true),
  ('ff000000-0000-0000-0000-000000000051', '00000000-0000-0000-0000-000000000007', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Full Chicken', 'Whole flame-grilled chicken', 160, 'FOOD', 20, true),
  ('ff000000-0000-0000-0000-000000000052', '00000000-0000-0000-0000-000000000007', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa', 'Wings Bucket (12pc)', 'Spicy or BBQ', 85, 'FOOD', 15, true),
  -- Vendor 8 (Suya)
  ('ff000000-0000-0000-0000-000000000060', '00000000-0000-0000-0000-000000000008', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaae', 'Beef Suya', 'Classic spiced beef', 60, 'FOOD', 8, true),
  ('ff000000-0000-0000-0000-000000000061', '00000000-0000-0000-0000-000000000008', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaae', 'Chicken Suya', 'Spiced chicken skewers', 55, 'FOOD', 8, true),
  ('ff000000-0000-0000-0000-000000000062', '00000000-0000-0000-0000-000000000008', 'aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaae', 'Ram Suya', 'Premium ram suya', 80, 'FOOD', 10, true);
